...
SPORTS = [
    ...
    # Update the 'url' for each sport if the slug is different.
    {
        ...
        'name':   'Boys Soccer',
        'season': '2026 season',
        'url':    'https://allmosports.com/boys-soccer-rankings-all-classes-2025-season/',
        'badgeBg':'#ede9fe',
        'badgeFg':'#4c1d95',
    },
    {
        ...
        'season': '2025 season',
        'url':    'https://allmosports.com/girls-volleyball-rankings-all-classes-2025-season/',
        'badgeBg':'#fdf2ff',
        'badgeFg':'#7e22ce',
    },
    {
        ...
        'name':   'Fall Softball',
        'season': '2025 season',
        'url':    'https://allmosports.com/fall-softball-rankings-all-classes-2025-season/',
        'badgeBg':'#e0f2fe',
        'badgeFg':'#0369a1',
    },
]
